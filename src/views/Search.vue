					...
					<div class="col" v-for="product in products" :key="product.id">
						<div class="card">
							<div class="text-center">
								<img v-if="!product.image" src="../assets/img/product_default.png"
									class="card-img-top width-modify" alt="Imagem do Produto">
								<img v-else :src="product.image" class="card-img-top width-modify"
