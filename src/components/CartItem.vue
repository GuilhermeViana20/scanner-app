<template>
    <div class="container">
        ...
        <div
            ...
            :key="index"
            class="d-flex align-items-center justify-content-between px-3 py-2 rounded-pill bg-box mb-3"
        >
            <img :src="product.image" alt="Produto" class="rounded-circle img-product me-2" width="40">
